						...
						<div class="col-md-6 ">
							<div class="box box-success">
								...
								<div class="box-body">
									...
									<div class="box-header with-border">
										<span class="box-title"><i class="fa fa fa-arrow-circle-right"></i>
											Tujuan</span>
									</div>
									...
									<div class="form-group">
										<div class="column-small-12 padd0 align-center">
											<div id="ambil_foto_tamu" class="drop-box" onclick="ambil_foto()">
												<p><i class="fa fa-camera" aria-hidden="true"></i><br>Ambil Foto Tamu
												</p>
											</div>
											<div class="text-center" id="hapus_foto_temporer" hidden>
												<i class="fa fa-times btn btn-danger" onclick="hapus_foto_temporer_tamu()" aria-hidden="true"> Hapus Foto
													Tamu</i>
											</div>
										</div>
	...
	<div class="modal-dialog" style="width:670px">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-warning pull-left" id="foto_ulang" onclick="foto_ulang()">Reset
					Cam</button>
...
<script type="text/javascript">
	...
	function _add_more() {
		...
		txt +=
			"<input type=\"file\" name=\"item_xnamalampiran[]\" class=\"btn btn-default col-sm-12\" onChange=\"checkExtension(this.value)\"></div>";
	...
	function _add_more_rfid() {
		...
		txt +=
			"<input type=\"number\" class=\"form-control\" name=\"item_xrfid[]\" placeholder=\"Focuskan kursor pada Kotak input dan scan kartu RFID\" required></div>";
