            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
                        <a href="<?php echo base_url() ?>data_buku_tamu/add_tamu" class="btn btn-success "><span
                                class="fa fa-plus"></span> Tambah Tamu</a>
                        <button class="btn btn-primary" data-toggle="modal" data-target="#ModalKartuTamu"><span
                                class="fa fa-exchange"></span> Pengembalian Kartu Tamu</button>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div id="dtBasicExample_filter" class="dataTables_filter">
                                    <label>Search:
                                        <input type="search" class="form-control form-control-sm filter" placeholder=""
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="col-sm-12">
                            <input type="text" name="nomor_kartu" class="form-control" id="nomor_kartu"
                                placeholder="nomor serial kartu" required />
...
function createTable(result, sno) {
    ...
    for (index in result) {
        ...
        if (photo != "") {
            var foto =
                '<img width="100" height="100" class="profile-user-img img-responsive" src="<?php echo base_url() ?>assets/images/foto_tamu/' +
                photo + '" onclick="modalimage(this.src)">';
        } else {
            var foto =
                '<img width="100" height="100" class="img-circle" src="<?php echo base_url() ?>assets/images/user_blank.png">';
        }
        sno += 1;
        var tr = "<tr>";
        tr += "<td>" + sno + ".</td>";
        ...
        tr += "<a href='<?php echo base_url() ?>data_buku_tamu/get_edit_tamu/" + id +
            "' class='btn btn-primary btn-edit' data-placement='top' data-tooltip='tooltip' title='Edit' ><span class='fa fa-edit'></span></a>&nbsp;";
        tr += "<a class='btn btn-danger btn-hapus' data-toggle='modal' data-id='" + id + "' data-foto='" + photo +
            "' data-target='#ModalHapus'  data-placement='left'  data-tooltip='tooltip' title='Hapus' ><span class='fa fa-trash'></span></a></td>";
        tr += "</tr>";
