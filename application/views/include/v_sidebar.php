...
<aside class="main-sidebar" style="padding-top: 70px;">
	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
			...
			<li class="<?php if ($controller == 'data_buku_tamu') {
							echo 'active';
						} ?>">
			...
			<li class="treeview <?php if ($controller == 'user' || $controller == 'pegawai' || $controller == 'bagian' || $controller == 'jabatan') {
									echo 'active';
								} ?>">
				<a href="#">
					<i class="fa fa-cog"></i>
				...
				<ul class="treeview-menu">
					<li class="<?php if ($controller == 'user') {
									echo 'active';
								} ?>">
					...
					<li class="<?php if ($controller == 'bagian') {
									echo 'active';
								} ?>">
					...
					<li class="<?php if ($controller == 'jabatan') {
									echo 'active';
								} ?>">
					...
					<li class="<?php if ($controller == 'pegawai') {
									echo 'active';
								} ?>">
