                ...
                <div class="box">
                    <div class="box-header with-border">
                        <a class="btn btn-success" data-toggle="modal" data-target="#myModal"><span
                                class="fa fa-user-plus"></span> Add Jabatan</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <form class="form-horizontal" action="<?php echo base_url().'jabatan/simpan_jabatan'?>" method="post"
...
<div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <form class="form-horizontal" action="<?php echo base_url().'jabatan/update_jabatan'?>" method="post"
            enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            ...
                            <input type="text" name="nama_jabatan" class="form-control" id="nama_jabatan"
                                value="<?php echo $nama_jabatan;?>" placeholder="Nama Lengkap" required>
                        </div>
                    </div>
                    <div class="form-group">
...
<div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <form class="form-horizontal" action="<?php echo base_url().'jabatan/hapus_jabatan'?>" method="post"
            enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
