            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
                        <a class="btn btn-success" data-toggle="modal" data-target="#myModal"><span
                                class="fa fa-plus"></span> Add Pegawai</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
...
<div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-labelledby="ModalEditLabel">
    <div class="modal-dialog" role="document">
        <form class="form-horizontal" action="<?php echo base_url().'pegawai/update_pegawai'?>" method="post"
            enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="jabatan" class="col-sm-3 control-label">Jabatan</label>
                        <div class="col-sm-9">
                            <select type="text" name="jabatan_update" class="form-control select2" id="jabatan_update"
                                required></select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="bagian" class="col-sm-3 control-label">Bagian</label>
                        <div class="col-sm-9">
                            <select type="text" name="bagian_update" class="form-control" id="bagian_update"
                                required></select>
                        </div>
                    </div>
                    <div class="form-group">
...
function createTable(result, sno) {
    ...
    for (index in result) {
        ...
        tr += "<td>" + no_hp + "</td>";
        tr += "<td>" + status + "</td>";
        tr += "<td class='text-center'> <a class='btn btn-info btn-edit' data-toggle='modal' data-id=" + id +
            " data-target='#ModalEdit' ><span class='fa fa-pencil'></span></a>";
        tr += "&nbsp;<a class='btn btn-warning btn-hapus' data-toggle='modal' data-id=" + id +
            " data-target='#ModalHapus'><span class='fa fa-trash'></span></a>";
        tr += "</td>";
        tr += "</tr>";
